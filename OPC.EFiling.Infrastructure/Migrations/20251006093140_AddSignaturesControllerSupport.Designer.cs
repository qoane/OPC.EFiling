...
namespace OPC.EFiling.Infrastructure.Migrations
{
    ...
    [Migration("20251006093140_AddSignaturesControllerSupport")]
    partial class AddSignaturesControllerSupport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CirculationResponse", b =>
                {
                    b.Property<int>("CirculationResponseId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CirculationResponseId"));

                    b.Property<int>("CirculationLogId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("CirculationResponseId");

                    b.HasIndex("CirculationLogId");
                    ...
                    b.ToTable("CirculationResponses", (string)null);
                });
            ...
            modelBuilder.Entity("OPC.EFiling.Domain.Entities.CirculationLog", b =>
                {
                    b.Property<int>("CirculationLogId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CirculationLogId"));
                    ...
                    b.ToTable("CirculationLogs", (string)null);
                });

            modelBuilder.Entity("OPC.EFiling.Domain.Entities.Comment", b =>
                {
            ...
            modelBuilder.Entity("OPC.EFiling.Domain.Entities.Signature", b =>
                {
            ...
            modelBuilder.Entity("OPC.EFiling.Domain.Entities.Template", b =>
                {
            ...
            modelBuilder.Entity("CirculationResponse", b =>
                {
                    b.HasOne("OPC.EFiling.Domain.Entities.CirculationLog", "CirculationLog")
                        .WithMany("Responses")
                        .HasForeignKey("CirculationLogId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OPC.EFiling.Domain.Entities.Document", "Document")
                        .WithMany()
                        .HasForeignKey("DocumentId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("User", "ReceivedByUser")
                        .WithMany()
                        .HasForeignKey("ReceivedByUserId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.Navigation("CirculationLog");
            ...
            modelBuilder.Entity("OPC.EFiling.Domain.Entities.CirculationLog", b =>
                {
                    ...
                    b.HasOne("OPC.EFiling.Domain.Entities.Draft", "Draft")
                        .WithMany("CirculationLogs")
                        .HasForeignKey("DraftId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("User", "SentByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("OPC.EFiling.Domain.Entities.Comment", b =>
                {
                    b.HasOne("OPC.EFiling.Domain.Entities.Comment", "ParentComment")
                        .WithMany("Replies")
